# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 09:59:55 2021
...
if not os.path.isfile("../Datasets/netflix/NetflixRatings.csv"): 
...
#in the folder "/Data/". If the file is present then it return true else false
    ...
    data = open("../Datasets/netflix/NetflixRatings.csv", mode = "w") #this line simply creates the file with the name "NetflixRatings.csv" in 
    #write mode in the folder "Data".
    files = ['../Datasets/netflix/combined_data_1.txt','../Datasets/netflix/combined_data_2.txt', '../Datasets/netflix/combined_data_3.txt', '../Datasets/netflix/combined_data_4.txt']
    for file in files:
